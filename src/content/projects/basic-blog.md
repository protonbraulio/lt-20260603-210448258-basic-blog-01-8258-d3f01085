...
featured: none
authors:
  - Basic Blog Load Test 01 20260603-210448258
title: Basic Blog 
description: >-
...
image:
  src: >-
    https://lt-20260603-210448258-basic-blog-01-8258-d3f01085.pages.dev/images/placeholder-card.svg
  alt: >-
    Screenshot of the "Basic Blog Load Test 01 20260603-210448258" blog homepage featuring a dark UI and three featured articles with hand-drawn, sketch-style illustrations on a textured tan background. 
ogImage:
  src: https://lt-20260603-210448258-basic-blog-01-8258-d3f01085.pages.dev/images/placeholder-card.svg
---
...
export const SITE_SETTINGS = {
  title: "Basic Blog Load Test 01 20260603-210448258 site",
  description: "A space to explore ideas and share what I'm learning",
  owner: "Basic Blog Load Test 01 20260603-210448258",
  ogImages:
    "https://lt-20260603-210448258-basic-blog-01-8258-d3f01085.pages.dev/images/placeholder-card.svg",
  socials: [
    {
      icon: "github",
      label: "GitHub",
      url: "https://github.com/lt-20260603-210448258-basic-blog-01-8258-d3f01085",
      handle: "lt-20260603-210448258-basic-blog-01-8258-d3f01085",
    },
  ],
};
```
...
<BaseLayout
    title="Search"
    description="Search articles and projects from Basic Blog Load Test 01 20260603-210448258."
		...
		handler: async ({ name, email, message, 'cf-turnstile-response': token }, ctx) => {
			...
			try {
				const { data, error } = await resend.emails.send({
					from: 'Contact Form <contact@mail.lt-20260603-210448258-basic-blog-01-8258-d3f01085.com>',
					to: ['lt-20260603-210448258-basic-blog-01-8258-d3f01085@gmail.com'],
					...
					html: `
						...
						<p>${escapeMessage}</p>
						<p style="color:#666">Sent from lt-20260603-210448258-basic-blog-01-8258-d3f01085.com</p>
                    `,
					text:
						...
						`Email: ${safeEmail}\n\n` +
						`Message:\n${messag}\n` +
						'— Sent from lt-20260603-210448258-basic-blog-01-8258-d3f01085.com',
				});
